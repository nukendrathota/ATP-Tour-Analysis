...
## Introduction
A fun and passionate ongoing project exploring the rich history of ATP Tour data from 1968 to May 2024. Through PostGRE SQL queries, this project uncovers key insights such as top players, American performances at the US Open, players with the best tiebreak record etc. Combining a love for tennis with data analytics, it showcases skills in data cleaning, analysis, and sports analytics.
